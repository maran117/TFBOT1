...
WELCOME_VID = environ.get("WELCOME_VID", "https://envs.sh/KNL.mp4")
...
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/678df66faaded07e71f3c-2e58a1a2a4433a9ae6.jpg') # Scanner Code image 
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://shallow-marie-ann-tamilflix525-b82d00c7.koyeb.app/'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://shallow-marie-ann-tamilflix525-b82d00c7.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://shallow-marie-ann-tamilflix525-b82d00c7.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://shallow-marie-ann-tamilflix525-b82d00c7.koyeb.app/".format(FQDN)
else:
    URL = "https://shallow-marie-ann-tamilflix525-b82d00c7.koyeb.app/".format(FQDN)

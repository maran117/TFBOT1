...
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002280475489)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002280475489)) # movies request channel, else log channel

...
ᴡᴇ ʜᴀᴠᴇ ᴅᴇᴠɪᴅᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""
    ...
    BLACKLIST = ['tamilblaster', 'filmyzilla', 'streamershub', 'xyz', 'cine', 'www', 'http', 'https',
                ...
                "Us", "DM_zz" , "boxoffice", "Links", "Linkz", "Villa", "Original", "bob", "Files1", "MW", "LinkZ", "}", "{" 
                ]
...
ᴏɴʟʏ ɴᴀᴍᴇ ᴏʀ ʏᴇᴀʀ ɴᴏ ᴇxᴛʀᴀ ᴡᴏʀᴅ</i>"""
    ...
    I_CUD_NT = """<blockquote> ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ...<blockquote>"""

    MVE_NT_FND = """<i>உங்கள் <b>{closest_movie}</b> திரைப்படம் எங்கள் நிர்வாகிக்கு அனுப்பப்பட்டுள்ளது.\n\n🚀 படம் பதிவேற்றம் செய்யப்பட்டவுடன் உங்களுக்கு செய்தி அனுப்புவோம்.\n\n📌 கவனம் - நிர்வாகி தனது பணியில் மும்முரமாக இருக்கிறார். படத்தை பதிவேற்றம் செய்ய நேரம் ஆகலாம்.</i>..."""
...
©️ Powered by: <b>{message.chat.title}</a>
<blockquote>📝 𝗔𝗻𝘆 𝗔𝗱𝘃𝗲𝗿𝘁𝗶𝘀𝗲𝗺𝗲𝗻𝘁  𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗡𝗼𝘄.👇</blockquote></a>
「<a href="https://t.me/TamilFlix_Admine_bot">𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐍𝐨𝐰 </a>」</b> """
...
💵 ᴜᴘɪ ɪᴅ - <code>maran3377@oksbi</code>
